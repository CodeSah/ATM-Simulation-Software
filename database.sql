...
create table signuptwo(formno varchar(20), religion varchar(20), occupation varchar(20), income varchar(20), education varchar(20),citizen varchar(20), pan varchar(20), seniorcitizen varchar(20), existingaccount varchar(20));
